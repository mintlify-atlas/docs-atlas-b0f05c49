...
description: Complete reference for all 9 function libraries and their purposes
---

The Proxmox VE Helper Scripts architecture uses 9 specialized function libraries that work together to create and manage LXC containers and VMs. Each library has a specific purpose and integration point.

...
<CardGroup cols={2}>
  ...
  <Card title="Installation Methods" icon="terminal" href="/getting-started/installation-methods">
...
<CardGroup cols={2}>
  <Card title="Run Your First Script" icon="play" href="/getting-started/quickstart">
    Follow our quickstart guide to install your first application
  </Card>
  <Card title="Explore Installation Methods" icon="book" href="/getting-started/installation-methods">
